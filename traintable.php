...
<head>
    ...
    <link rel="stylesheet" href="traintable.css">
</head>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td><form method="POST" action="Ticketbooking.html">';
     echo '<button type="submit" name="Select" value="' . $row["I_ID"] . '">Select</button>';
